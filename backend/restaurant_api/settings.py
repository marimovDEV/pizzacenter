...
UNFOLD = {
    "SITE_TITLE": "🍽️ Pizza Centr Garden Admin",
    "SITE_HEADER": "Pizza Centr Garden - Boshqaruv Paneli",
    "SITE_URL": "/",
    "SITE_ICON": {
    ...
    "ENVIRONMENT": "Pizza Centr Garden Boshqaruv Paneli",
