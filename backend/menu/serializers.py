...
from .models import Category, MenuItem, Promotion, Review, ReviewAction, Order, OrderItem, SiteSettings, RestaurantInfo, Cart, CartItem, Feedback, FeaturedDish
...
class CategorySerializer(serializers.ModelSerializer):
    ...
    def get_image_thumbnail(self, obj):
        try:
            if obj.image and hasattr(obj, 'image_thumbnail') and obj.image_thumbnail:
    ...
    class Meta:
        model = Category
        fields = ['id', 'name', 'name_uz', 'name_ru', 'icon', 'image', 'image_thumbnail', 'order', 'is_active', 'created_at', 'updated_at']
...
class MenuItemSerializer(serializers.ModelSerializer):
    ...
    def get_image_mobile(self, obj):
        try:
            if obj.image and hasattr(obj, 'image_mobile') and obj.image_mobile:
    ...
    class Meta:
        ...
        fields = [
            ...
            'price', 'weight', 'image', 'image_thumbnail', 'image_mobile', 'category', 'global_order', 'category_order', 'category_name', 'category_name_uz', 'category_name_ru',
...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    def get_menu_item_image(self, obj):
        if obj.menu_item.image_thumbnail:
            return obj.menu_item.image_thumbnail.url
...
class FeaturedDishSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FeaturedDish
        fields = ['id', 'menu_item', 'menu_item_id', 'order', 'is_active', 'created_at', 'updated_at']
