...
from .serializers import (
    ...
    FeedbackSerializer, FeaturedDishSerializer
)
...
class MenuItemDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def perform_update(self, serializer):
        ...
        with transaction.atomic():
            ...
            # Instance ni qayta yuklash va serializer ni yangilash
...
class SiteSettingsView(generics.RetrieveAPIView):
    ...
    def get_object(self):
        ...
        obj, created = SiteSettings.objects.get_or_create(
            defaults={
                'site_name': 'Pizza Centr Garden',
                'site_name_uz': 'Pizza Centr Garden',
                'site_name_ru': 'Ресторан Pizza Centr Garden',
            }
        )
        return obj
...
class RestaurantInfoView(generics.RetrieveAPIView):
    ...
    def get_object(self):
        ...
        obj, created = RestaurantInfo.objects.get_or_create(
            defaults={
                'restaurant_name': 'Pizza Centr Garden',
                'restaurant_name_uz': 'Pizza Centr Garden',
                'restaurant_name_ru': 'Ресторан Pizza Centr Garden',
            }
        )
        return obj
...
class FeaturedDishListView(generics.ListAPIView):
    """API endpoint for featured dishes"""
    queryset = FeaturedDish.objects.filter(is_active=True).order_by('order')
    serializer_class = FeaturedDishSerializer
    permission_classes = [AllowAny]
